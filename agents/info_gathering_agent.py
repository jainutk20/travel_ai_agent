...
Output all the information for the trip you have in the required format. 
Also ask the user for any missing information if necessary. Tell the user what information is they still need to provide.
"""
